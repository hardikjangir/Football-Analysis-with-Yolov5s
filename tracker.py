...
class Tracker:
    ...
    def get_object_trackers(self,frames, read_from_stub=False, stub_path=None):
        ...
        for frame_num, detection in enumerate(detections):
            ...
            #convert t o supervision detection formsat
            ...
            for frame_detection in detection_with_tracks:
                ...
                #we dont need a traacker for the ball bounding box is sufficient for it 
            ...
            for frame_detection in detection_supervision:
                ...
                if cls_id==cls_names_inv['ball']:
                    #here track id is replaced by 1
